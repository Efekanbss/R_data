...
data_1 <- read_xlsx("RStudio/ad_cinsiyet_okulnu.xlsx")

data_1$renkler <- ifelse(data_1$Cinsiyet == "E", "mavi", "pembe")

#For

#c() → aynı türden elemanları yan yana koyar → vektör.
#list() → farklı türleri bir arada tutabilir → liste.
merhaba <- c()
...
# üstteki for döngüsüyle "merhaba <- 1:10" bu aynı işlevde
